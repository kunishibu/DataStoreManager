...
public class DataStoreExporterMessage extends AbstractMessage{
	...
	/** 変数値が設定されていません。 */
	public static final DataStoreExporterMessage VALIABLE_IS_NOT_SET = new DataStoreExporterMessage("E001");
	
	/** 変数型に不明な値が設定されています。 */
	public static final DataStoreExporterMessage VALIABLE_TYPE_IS_UNKNOWN = new DataStoreExporterMessage("E002");
	
	/** 変数に不正な値が設定されています。 */
	public static final DataStoreExporterMessage VALIABLE_IS_CHECK_ERROR = new DataStoreExporterMessage("E003");
	
	/** 変数の値が指定されていません。変数名=[{0}] */
	public static final DataStoreExporterMessage VALUE_IS_NOT_SET = new DataStoreExporterMessage("E004");
	
	/** パラメータのフォーマットが不正です。パラメータ=[{0}] */
	public static final DataStoreExporterMessage PARAMETER_FORMAT_IS_INVALID = new DataStoreExporterMessage("E005");
