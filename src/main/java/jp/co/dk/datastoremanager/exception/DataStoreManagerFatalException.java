 ...
 * @author D.Kanno
 */
public class DataStoreManagerFatalException extends AbstractMessageFatalException{
	 ...
	 * @since 1.1
	 */
	public DataStoreManagerFatalException(MessageInterface msg){
		super(msg);
	 ...
	 * @since 1.1
	 */
	public DataStoreManagerFatalException(MessageInterface msg, String str){
		super(msg, str);
		this.logger.error(this.getMessage());
	}
	 ...
	 * @since 1.1
	 */
	public DataStoreManagerFatalException(MessageInterface msg, List<String> list){
		super(msg, list);
		this.logger.error(this.getMessage());
	}
	 ...
	 * @since 1.1
	 */
	public DataStoreManagerFatalException(MessageInterface msg, Throwable throwable){
		super(msg, throwable);
		this.logger.error(this.getMessage());
	}
	 ...
	 * @since 1.1
	 */
	public DataStoreManagerFatalException(MessageInterface msg, String str, Throwable throwable){
	 ...
	 * @since 1.1
	 */
	public DataStoreManagerFatalException(MessageInterface msg, List<String> list,Throwable throwable){
