...
import jp.co.dk.datastoremanager.rdb.TimestampSqlParameter;

import org.junit.Test;

import static jp.co.dk.datastoremanager.message.DataStoreManagerMessage.*;

public class TimestampSqlParameterTest extends DataStoreManagerTestFoundation{
	...
	public void constractor() throws ParseException {
		...
		// コンストラクタに文字列オブジェクトを設定した場合、正常に値が設定できること。
		try {
			new TimestampSqlParameter(null);
		} catch (DataStoreManagerException e) {
